...
/**
 * Servlet implementation class EmployManageSubmit
 */
//@WebServlet("/EmployManageSubmit")
public class EmployManageSubmit extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public EmployManageSubmit() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		sql.getConnection();
		String sqlSentenceUpdatePost ="update 员工表 set `End-time` = "+"'"+date.toString()+"'"+" where Id= "+id_int ;
